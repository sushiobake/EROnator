...
import { SimRecentFiveExitColumnCell, SimEarlyExitJudgmentColumnCell, EARLY_EXIT_OK_COLOR } from '../components/SimEarlyExitColumnCell';
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', tableLayout: 'auto' }}>
                      <thead>
                        <tr style={{ background: '#f0f0f0' }}>
                          ...
                          <th style={{ padding: '0.5rem', textAlign: 'left', width: '5.85rem', minWidth: '5.85rem', boxSizing: 'border-box', whiteSpace: 'nowrap' }}>直近５問（③）</th>
                      ...
                      <tbody>
                        {simResult.steps.map((step, i) => {
                          ...
                          const eeOk = simEarlyExitOkInline[i] ?? { conf: false, cand: false, delta: false };
                          return (
                            <tr 
                              key={i} 
                              style={{ 
                            ...
                            >
                              ...
                              <td style={{ padding: '0.5rem', textAlign: 'left', verticalAlign: 'top' }}>
                                <SimRecentFiveExitColumnCell ex={ex} isReveal={isReveal} ok={eeOk.delta} />
                              </td>
                              <td style={{ padding: '0.5rem', textAlign: 'left', verticalAlign: 'top' }}>
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', tableLayout: 'auto' }}>
                          ...
                          <tbody>
                            {simResultModal.steps.map((step, idx) => {
                              ...
                              const ex = (step as { earlyExit?: import('@/types/earlyExitStepSnapshot').EarlyExitStepSnapshot }).earlyExit;
                              const eeOk = simEarlyExitOkModal[idx] ?? { conf: false, cand: false, delta: false };
