...
function StageInner({ children, showLogo, characterSpeech }: { children: React.ReactNode; showLogo?: boolean; characterSpeech?: React.ReactNode }) {
  return (
    <>
      <div
        style={{
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <StageInner showLogo={showLogo} characterSpeech={characterSpeech}>{children}</StageInner>
        </div>
      </div>
      <footer
        style={{
