  ...
  useEffect(() => {
    ...
    if (isLandscape) {
      const update = () => {
        ...
        let availH = window.outerHeight - MOBILE_HEADER_HEIGHT - MOBILE_FOOTER_HEIGHT - margin - MOBILE_LANDSCAPE_SAFE_HEIGHT;
    ...
    const update = () => {
      const w = window.outerWidth;
      const h = window.outerHeight - MOBILE_HEADER_HEIGHT - MOBILE_FOOTER_HEIGHT;
    ...
    return (
      <div style={wrapperStyle}>
        ...
        >
          ...
          <span style={{ fontSize: 12, color: 'rgba(255,255,255,0.7)' }}>SNS</span>
        </header>
        <div
          ref={centerRef}
          style={{
        ...
        >
          <div
            style={{
              ...
              position: 'relative',
              flexShrink: 0,
              transform: `scale(${mobileCenterScale * 0.5})`,
