...
export function DebugPanel({ debug, revealAnalysis, open, onToggle, attachTop }: DebugPanelProps) {
  // debugがnullでも、デバッグパネルのヘッダーは表示する（デバッグ情報がないことを示すため）
  const topStyle = attachTop
    ? { top: 0, left: 0, right: 0, width: '100%', maxWidth: '100%' }
    : { top: '20px', left: '20px', width: '510px', maxWidth: 'calc(100vw - 48px)' };
    ...
    return (
      <div
        style={{
          ...
          borderRadius: attachTop ? '0 0 8px 8px' : '8px',
