...
interface QuizProps {
  ...
  onBack?: () => void;
  canGoBack?: boolean;
  /** 質問文を別枠（topContent）で表示する場合は true。質問ブロックを省略。 */
...
export function Quiz({ question, questionCount, onAnswer, onBack, canGoBack, hideQuestion }: QuizProps) {
  ...
  return (
    <>
      ...
      <div style={{ width: '100%', maxWidth: 320, marginTop: hideQuestion ? 0 : isMobile ? 6 : 8 }}>
        <div
          style={{
            display: 'flex',
