    ...
    <div>
      ...
      {activeStep === 'api' && (
        <div style={{ padding: '15px', border: '1px solid #ddd', borderRadius: '8px' }}>
          <h3>DMM APIから作品をインポート（段階的）</h3>
          <p style={{ color: '#666', fontSize: '14px' }}>
            新規作品をDBに追加します。ソート・開始オフセットを指定して段階的にインポートできます。
            <br />
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', marginBottom: '15px', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: '5px', alignItems: 'center', flexWrap: 'wrap' }}>
              ...
              <span style={{ fontSize: '12px', color: '#666' }}>（デフォルト: 全期間。年指定でその年発売のみ）</span>
            </div>
            <button
