...
export default function Home() {
  ...
  const [pendingThinkingType, setPendingThinkingType] = useState<'opening' | 'inGame' | 'endingCorrect' | 'endingWrong' | null>(null);
  ...
  useEffect(() => {
    if (!isClient) return;
    const paths = ['/ilust/inari_thinking.png', '/ilust/inari_thinking_opening.png', '/ilust/inari_thinking_early.png', '/ilust/inari_thinking_mid.png', '/ilust/inari_thinking_late.png', '/ilust/inari_thinking_closing.png', '/ilust/inari_thinking_ending_correct.png', '/ilust/inari_thinking_ending_wrong.png'];
