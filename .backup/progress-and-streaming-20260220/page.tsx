            ...
            <div style={{ marginTop: '1.5rem', display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              <button
                onClick={async () => {
                  ...
                  setSimLoading(true);
                  setSimResult(null);
                  setProgress('simulate', { current: 0, total: 1, phase: '単発' });
                  try {
              ...
              <div style={{ 
                ...
                <button
                  onClick={async () => {
                    ...
                    const batchTotal = simSampleSize > 0 ? simSampleSize * simTrialsPerWork : 5000;
                    setProgress('simulate', { current: 0, total: batchTotal, phase: 'バッチ' });
                    try {
                      const response = await fetch('/api/admin/simulate', {
                        method: 'PUT',
                        headers: { 'Content-Type': 'application/json' },
